...
public partial class EducationalBooksListingRow : ContentView
{
    public static readonly BindableProperty TitleProperty =
        BindableProperty.Create(nameof(Title), typeof(string), typeof(EducationalBooksListingRow), default(string));

    public static readonly BindableProperty ListingTitleProperty =
       BindableProperty.Create(nameof(ListingTitle), typeof(string), typeof(EducationalBooksListingRow), default(string));

    public static readonly BindableProperty ItemsProperty =
        BindableProperty.Create(nameof(Items), typeof(List<EducationCover>), typeof(EducationalBooksListingRow), propertyChanged: OnItemsChanged);

    public static readonly BindableProperty CoverStrokeProperty =
        BindableProperty.Create(nameof(CoverStroke), typeof(Brush), typeof(EducationalBooksListingRow), OvulaeColors.BRUSH.BrushThemeClr2);

    public static readonly BindableProperty CoverBackgroundProperty =
        BindableProperty.Create(nameof(CoverBackground), typeof(Brush), typeof(EducationalBooksListingRow), OvulaeColors.BRUSH.BrushThemeClrLight);
    ...
    {
        get => (string)GetValue(ListingTitleProperty);
        set => SetValue(ListingTitleProperty, value);
    }
    ...
    BindableProperty.Create(nameof(LabelFontSize), typeof(double), typeof(EducationalBooksListingRow), 12.0);

    public static readonly BindableProperty LabelMarginProperty =
        BindableProperty.Create(nameof(LabelMargin), typeof(Thickness), typeof(EducationalBooksListingRow), new Thickness(5));

    public static readonly BindableProperty LabelTextColorProperty =
        BindableProperty.Create(nameof(LabelTextColor), typeof(Color), typeof(EducationalBooksListingRow), Colors.Black);

    public static readonly BindableProperty LabelFontAttributesProperty =
        BindableProperty.Create(nameof(LabelFontAttributes), typeof(FontAttributes), typeof(EducationalBooksListingRow), FontAttributes.Bold);

    public static readonly BindableProperty ScrollPaddingProperty =
        BindableProperty.Create(nameof(ScrollPadding), typeof(Thickness), typeof(EducationalBooksListingRow), new Thickness(20, 0, 0, 0));
    ...
    BindableProperty.Create(nameof(CoverTappedCommand), typeof(Command<EducationCover>), typeof(EducationalBooksListingRow));
    ...
    public EducationalBooksListingRow()
    {
        InitializeComponent();
    }
    ...
    {
        if (bindable is EducationalBooksListingRow view && newValue is List<EducationCover> newItems)
        {
