...
{
    public partial class PaymentFailedPageIOS : ContentPage
    {
        ...
        public PaymentFailedPageIOS(IPaystackApi paystackApi, IUserLocalService usersServ, IUsersApi userApi)
        {
            InitializeComponent();
