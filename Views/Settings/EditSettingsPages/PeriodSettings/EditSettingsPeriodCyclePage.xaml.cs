...
namespace OvulaeApp.Views.Settings.EditSettingsPages.PeriodSettings
{
    public partial class EditSettingsPeriodCyclePage : ContentPage
    {
        private EditSettingPeriodSettingsViewModel vm;

        private readonly IUserLocalService _usersServ;
        
        public EditSettingsPeriodCyclePage(IUserLocalService usersServ)
        {
            InitializeComponent();
        ...
        private async void SaveChangesTapped(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var updated = await _usersServ.UpdateUserCycleProfile();
